                    ...
                    <?php foreach ($cakes as $cake): ?>
                        <div class="cart-card">
                            ...
                            <div class="cake-info">
                                ...
                                <p style="font-weight: bold; color: var(--primary)">₱ <?= number_format($cake['cake_price'], 2) ?></p>
                                ...
                                <div class="quantity-container">
                                    <div class="quantity-control" data-product-id="<?= $cake['cake_id'] ?>">
                                        ...
                                        <input type="number" id="quantity-<?= $cake['cake_id'] ?>" class="quantity-input" value="<?= $cake['quantity'] ?>" min="1">
